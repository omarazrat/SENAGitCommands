...
**Descipción**
Se tiene la base de datos de una empresa de venta de papel.
Los roles son:
- vendedor : Hace una venta y la reporta al sistema.
- bodeguero: Gestiona la bodega de papel.
- contable: Paga la nómina, impuestos, gestiona el dinero de la empresa.
